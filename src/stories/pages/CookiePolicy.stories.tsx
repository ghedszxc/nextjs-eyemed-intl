...
import { CookiePolicy as CookiePolicy } from "@/stories/widgets/HeroBanner.stories";
import { CookiePolicy as CookiePolicyData } from "@/stories/widgets/ArticleText.stories";
...
export const Default: Story = {
  render: (args) => (
    <Home {...args}>
      ...
      <HeroBanner {...CookiePolicy.args} picture={undefined} variant="small" />

      <ArticleText
        bodyText={CookiePolicyData.args?.bodyText || ""}
        // subtitle={CookiePolicyData.args?.subtitle || ""}
        title1={CookiePolicyData.args?.title1 || ""}
        padding="both"
      />
